...
const buildPalette = (mode: PaletteMode) => {
  if (mode === 'light') {
    return {
      ...
      background: { default: '#f5f7fb', paper: 'rgba(255,255,255,0.9)' },
      text: { primary: '#0f172a', secondary: 'rgba(71,85,105,0.85)' },
    }
  }
  ...
  return {
    ...
    background: { default: '#05070d', paper: 'rgba(15,23,42,0.85)' },
    text: { primary: '#e2e8f0', secondary: 'rgba(148,163,184,0.8)' },
  }
}
...
export const createAppTheme = (mode: PaletteMode) => buildTheme(mode)
