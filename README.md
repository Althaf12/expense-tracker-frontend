...
Simple React + Vite frontend that fetches expenses from `http://localhost:8081/api/expenses` and displays them.
...
Notes
- The backend API must be running and accessible at `http://localhost:8081/api/expenses`.
